...
public class SqliteTemplateRepositoryTests : IDisposable
{
    private readonly TestEnvironment _env = new();
    private readonly ITemplateRepository _sut;

    public SqliteTemplateRepositoryTests()
    {
        _sut = new SqliteTemplateRepository(_env.ConnectionString);
    }
